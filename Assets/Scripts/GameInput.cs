...
public class GameInput : MonoBehaviour
{
    ...
    void Pause_Onperformed(InputAction.CallbackContext obj)
    {
        OnPauseAction?.Invoke(this, EventArgs.Empty);
    }
    void InteractAlternate_OnPerformed(InputAction.CallbackContext obj)
    {
        OnInteractAlternateAction?.Invoke(this, EventArgs.Empty);
    }
    void Interact_OnPerformed(InputAction.CallbackContext obj)
    {
